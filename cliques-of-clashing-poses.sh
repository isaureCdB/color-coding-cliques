...
./color-coding-cliques/select_connected.py $graph.npz --start 1 > $graph-connected.list
...
./color-coding-cliques/same-position.py $graph-connected.npz --npy $graph-L1.npy --txt $graph-L1.txt
